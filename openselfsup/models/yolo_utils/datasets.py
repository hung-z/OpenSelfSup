...
from utils.general import xyxy2xywh, xywh2xyxy, torch_distributed_zero_first, clip_coords
from utils.augmentation import Albumentations
...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(self, path, img_size=640, batch_size=16, augment=False, hyp=None, rect=False, image_weights=False,
        ...
        if self.albumentations is not None:
            print("Using Albumentations augmentation to avoid overfitting")
    ...
    def __getitem__(self, index):
        ...
        if nL:
            clip_coords(labels[:, 1:], (img.shape[0] - EPS_TEMP, img.shape[1] - EPS_TEMP))
