...
from utils.v5_general import colorstr, segment2box, resample_segments, check_version
from utils.v5_metrics import bbox_ioa
...
class Albumentations:
    ...
    def __init__(self):
        ...
        try:
            ...
            print("Do not have albumentations")
            exit(0)
            pass
